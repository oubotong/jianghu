...
const glossary=[['block','护盾','每1点护盾抵挡1点攻击伤害。你的剩余护盾在下回合开始时清空；敌人的护盾在它行动时重新设置。'],['damage','伤害与穿透','攻击先扣敌人护盾，剩余部分才扣生命。「无视护盾」直接扣生命。多段攻击逐次结算，每一段都可能被护盾抵挡。'],['poison','洗脑','敌人每次行动前，失去等于当前层数的生命，无视护盾，然后减少1层。可叠加，上限30层。'],['weak','虚弱','降低敌人25%的攻击伤害，向下取整。每次敌人行动后减少1回合，叠加后最多持续4回合。'],['energy','能量','左上角数字是出牌需要支付的能量。每回合恢复为3点，剩余能量不保留。0费牌也可以在能量用完时打出。'],['draw','抽牌、弃牌与移出本场','手牌最多10张，超出时停止抽牌。用过或回合结束时没用的牌进入弃牌堆，抽牌堆空了便洗回。「本场仅用一次」的牌进入移出区，下场战斗恢复。']];
